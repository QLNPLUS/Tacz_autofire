...
This client-side addon for **Timeless & Classics Guns (TACZ)** (Forge 1.20.1) lets you configure exactly **which weapons** can be fired full-auto, through four independent modes and global gun ID rules:
...
本模组是 **Timeless & Classics Guns (TACZ)**（Forge 1.20.1）的客户端附属模组，通过四种互不干扰的模式，让你自定义**哪些武器**可以全自动开火：
