...
public final class AutoFireConfig {
    ...
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> GLOBAL_BLACKLIST;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> GLOBAL_WHITELIST;
